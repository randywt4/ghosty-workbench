  ...
  return (
    <div
      ...
      className={cn(
        ...
        "before:pointer-events-none before:absolute before:inset-0 before:z-0 before:rounded-lg before:bg-[color-mix(in_srgb,var(--chat-composer-glass-surface)_var(--glass-opacity),transparent)] before:backdrop-blur-(--glass-blur) before:backdrop-saturate-(--glass-saturation)",
...
function Host({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "relative z-10 w-full rounded-lg shadow-[0_12px_28px_-18px_rgb(0_0_0/40%)] after:z-1 dark:shadow-none",
        outlineClasses,
        contextSeamClasses,
