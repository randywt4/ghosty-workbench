...
type Props = {
  ...
  /** Renders the name field readonly (group display) instead of editable. */
  ...
  onClose: () => void;
  ariaLabel?: string;
  /** When false, only name / mascot / color controls are shown. */
  showActions?: boolean;
    ...
    <>
      ...
      >
        ...
        <input
          ...
          className="mb-2 w-full rounded-lg border border-content/10 bg-content/5 px-2.5 py-1.5 text-[13px] text-content outline-none ring-monocode-accent/40 focus:ring-1"
        />
  ...
  return (
    <button
      ...
      className={`grid size-5 shrink-0 place-items-center rounded-md ${
        selected ? "bg-selection-hover ring-1 ring-content/50" : "hover:bg-content/8"
      }`}
    >
      {children}
    </button>
